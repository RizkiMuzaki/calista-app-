...
ew_table_name; CREATE TABLE `anaks` (
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `artikels` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `books` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `cache` (
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `cache_locks` (
  `key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `counting_items` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `failed_jobs` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `f_a_q_s` (
  `id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `games` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `hadiahs` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `jobs` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `job_batches` (
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `levels` (
  `id` bigint UNSIGNED NOT NULL,
  `module_id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `migrations` (
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `modules` (
  `id` bigint UNSIGNED NOT NULL,
  `foto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `page_books` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `password_reset_tokens` (
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `payments` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `plans` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `progres_anaks` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `puzzle_items` (
  `id` bigint UNSIGNED NOT NULL,
  `level_id` bigint UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `sessions` (
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` bigint UNSIGNED DEFAULT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `story_choices` (
  `id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `story_images` (
  `id` bigint UNSIGNED NOT NULL,
  `story_page_id` bigint UNSIGNED NOT NULL,
  `image_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `story_pages` (
  `id` bigint UNSIGNED NOT NULL,
  `book_id` bigint UNSIGNED NOT NULL,
  `page_number` int NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `subscriptions` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `users` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS 
ew_table_name; CREATE TABLE `writing_items` (
  `id` bigint UNSIGNED NOT NULL,
  `level_id` bigint UNSIGNED NOT NULL,
